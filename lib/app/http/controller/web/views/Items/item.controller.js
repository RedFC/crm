...
class Views {
    create(req, res) {
        res.render(path_1.default.join(appRoot.path, "views/pages/item/create.ejs"));
    }
    ;
    set(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let create = yield myUserservice.create(schema);
                if (create) {
    ...
    view(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let myUserservice = new Items_service_1.ItemService();
                let get = yield myUserservice.findAll();
                if (get) {
                    res.render(path_1.default.join(appRoot.path, "views/pages/item/view.ejs"), { data: get });
                }
            }
            catch (error) {
                console.log(error);
    ...
    edit(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (get) {
                    res.render(path_1.default.join(appRoot.path, "views/pages/item/edit.ejs"), { data: get });
                }
            }
            catch (error) {
                console.log(error);
