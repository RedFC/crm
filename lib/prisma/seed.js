...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        const Shwop_Admin = yield prisma.user.upsert({
        ...
        const Hannah_Olive = yield prisma.user.upsert({
        ...
        const Suzy_Adams = yield prisma.user.upsert({
        ...
        const Jimmy_Harper = yield prisma.user.upsert({
